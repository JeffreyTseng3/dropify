...
class songCollectionItem extends React.Component {
    constructor(props) {
        super(props);
    ...
    handleDoubleClick( songId) {
        let { fetchCurrentSong, setMusicPlayType, myIds } = this.props;
        fetchCurrentSong(songId);
        let musicPlayType = { songCollection: myIds }
    ...
    render() {
        ...
        let options_playlist_modal = mySong ? 'options,songCollection,' + String(mySong.id) : null;
        ...
        return (<>
            ...
            >
                ...
                <button className="song-info-btn"
                    onDoubleClick={() => this.handleDoubleClick( mySong.id)}>
